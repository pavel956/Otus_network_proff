...
<img src="shem.png" alt="image" width="70%" height="auto">
...
- Настроим отслеживание IP SLA для линка в сторону R25. каждые 5 секунд будет проверяться ip соседство посредством пинга icmp. Правило sla 1 будет работать бесконечно, и запускается немедленно.
<pre><code>
ip sla 1
